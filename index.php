...
<head>
    ...
    <meta name="description" content="Agendador de tarefas do departamento tecnico">
...
<body>
    ...
    <div class="board">
    <div class="list" id="afazer-lista" style="background-color: <?php echo obterCorFundo('afazer'); ?>;">
